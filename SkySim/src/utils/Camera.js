...
export class Camera {
  ...
  update(dt) {
    ...
    this.rotateForward((dt / 1000) * this.KeyValues.MouseMovementY * this.KeyValues.MouseRotationSpeed);
    this.rotateRight((dt / 1000) * this.KeyValues.MouseMovementX * this.KeyValues.MouseRotationSpeed);
